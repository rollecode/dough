// Shared brand colours and icons for recurring payments (subscriptions and bills),
...
export function BrandIcon({ svg, logo, img }: { svg?: string; logo?: string; img?: string }) {
  ...
  if (svg === "runna") {
    // Runna app-icon mark (stylised "R" runner plus the head dot), traced from the official icon.
    // Coordinates are in potrace's space; the group transform maps them into the viewBox.
    return (
      <svg viewBox="283 179 461 664" width="20" height="20" fill="#fff">
        <g transform="translate(0,1024) scale(0.1,-0.1)">
          <path d="M6315 8236 c-49 -7 -99 -18 -110 -24 -11 -6 -51 -25 -90 -43 -79 -37 -188 -122 -255 -198 -47 -54 -140 -223 -140 -254 0 -10 -8 -32 -17 -50 -15 -27 -18 -58 -18 -187 0 -129 3 -160 18 -187 9 -18 17 -40 17 -50 0 -10 8 -34 19 -53 10 -19 22 -46 26 -60 24 -77 181 -249 275 -301 19 -10 42 -23 50 -28 40 -25 99 -49 135 -55 21 -4 52 -14 67 -22 45 -23 279 -19 351 6 31 11 63 20 72 20 8 0 29 9 47 20 18 11 39 20 46 20 13 0 131 78 171 114 51 45 151 180 182 244 136 288 82 624 -139 857 -185 197 -412 271 -707 231z"/>
          <path d="M3063 6929 c-21 -21 -16 -33 46 -107 33 -39 86 -106 118 -149 139 -184 197 -259 212 -275 9 -9 45 -56 81 -103 111 -146 282 -360 294 -367 6 -4 179 -8 385 -8 396 0 510 -10 593 -51 21 -11 42 -19 48 -19 48 0 240 -171 280 -250 11 -21 24 -41 29 -44 5 -4 13 -21 16 -39 4 -17 14 -45 22 -61 54 -106 52 -452 -3 -583 -60 -142 -121 -229 -216 -306 -54 -45 -81 -39 -128 28 -14 19 -32 44 -40 55 -8 10 -46 60 -85 110 -38 50 -108 140 -155 200 -47 60 -100 130 -119 154 l-33 46 -677 2 c-372 2 -682 1 -688 -1 -25 -6 -12 -32 55 -115 37 -46 76 -96 87 -111 58 -81 221 -294 298 -390 37 -47 67 -87 67 -90 0 -6 203 -274 240 -316 8 -10 33 -43 55 -74 22 -30 67 -91 100 -134 33 -43 92 -120 130 -170 39 -51 90 -119 115 -152 25 -32 74 -98 110 -145 36 -47 101 -133 145 -190 44 -57 99 -130 123 -161 115 -155 148 -199 162 -214 8 -8 22 -26 30 -38 15 -23 54 -77 85 -116 8 -11 50 -65 91 -120 42 -55 108 -142 147 -193 40 -51 88 -115 107 -142 19 -26 75 -100 123 -164 l89 -116 707 0 c389 0 710 3 714 6 10 10 -18 54 -64 104 -23 25 -49 58 -59 73 -17 28 -64 89 -222 287 -49 61 -88 113 -88 115 0 3 -29 43 -65 88 -90 114 -243 312 -350 452 -49 64 -100 129 -113 144 -44 50 -187 236 -229 298 -41 60 -48 93 -18 93 8 0 27 11 43 25 17 14 33 25 37 25 45 0 445 401 445 446 0 3 13 22 29 42 79 100 198 354 223 477 5 27 16 61 23 76 8 14 17 57 21 95 3 38 12 91 20 118 19 67 19 319 0 395 -8 31 -17 90 -21 131 -4 41 -13 87 -21 102 -8 15 -17 48 -21 74 -3 25 -14 62 -24 82 -11 20 -19 42 -19 49 0 32 -86 202 -159 313 -99 152 -268 339 -357 396 -16 10 -32 22 -35 27 -3 5 -17 16 -31 25 -14 9 -45 30 -69 47 -50 34 -90 57 -135 78 -17 8 -35 20 -38 26 -4 6 -15 11 -24 11 -9 0 -30 7 -47 16 -129 70 -390 145 -594 172 -160 20 -1779 30 -1798 11z"/>
        </g>
      </svg>
    );
  }
