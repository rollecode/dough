...
export const BRANDS: Record<string, { color: string; logo: string; svg?: string; img?: string }> = {
  netflix: { color: "#E50914", logo: "N", img: "netflix.svg" },
  spotify: { color: "#1DB954", logo: "S", img: "spotify.svg" },
  disney: { color: "#113CCF", logo: "D+" },
  "hbo max": { color: "#5822B4", logo: "H" },
  "apple tv": { color: "#000000", logo: "" },
  "apple music": { color: "#FC3C44", logo: "♪", img: "applemusic.svg" },
  ...
  anthropic: { color: "#cc785c", logo: "A", img: "anthropic.svg" },
  icloud: { color: "#3693F3", logo: "", img: "icloud.svg" },
  "apple icloud": { color: "#3693F3", logo: "", img: "icloud.svg" },
  "ultra.cc": { color: "#14b89f", logo: "U", img: "ultracc.svg" },
  ultra: { color: "#14b89f", logo: "U", img: "ultracc.svg" },
  elisa: { color: "#009bdb", logo: "E" },
  telia: { color: "#990AE3", logo: "T" },
  dna: { color: "#00A651", logo: "D" },
  nextdns: { color: "#007BFF", logo: "N", img: "nextdns.svg" },
  oura: { color: "#2F4A73", logo: "O", img: "oura.svg" },
  "no-ip": { color: "#8fbe00", logo: "N", img: "noip.svg" },
  bookbeat: { color: "#CD96FF", logo: "B", img: "bookbeat.svg" },
